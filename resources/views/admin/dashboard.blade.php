...
<div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-2">
    ...
    <div class="flex items-center gap-2 mt-1 sm:mt-0">
        <a href="{{ route('admin.revenus.details') }}" class="inline-flex items-center gap-1.5 px-2.5 py-1 rounded-full bg-slate-800 dark:bg-slate-700 text-white hover:bg-slate-900 text-[11px] font-bold transition-all">
