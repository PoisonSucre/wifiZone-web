            ...
            <div class="relative bg-white dark:bg-darkCard border border-slate-200/80 dark:border-darkBorder hover:border-cyan-500/50 rounded-2xl transition-all duration-300 hover:-translate-y-0.5 group overflow-hidden">
                ...
                <div class="relative p-4 flex items-center gap-3">
                    ...
                    <div class="flex flex-col min-w-0 flex-1">
                        ...
                        <p class="text-xl sm:text-2xl font-black text-slate-900 dark:text-white tracking-tight leading-none">{{ $nbTotal }}</p>
                    </div>
                </div>
            </div>
            ...
            <div class="relative bg-white dark:bg-darkCard border border-slate-200/80 dark:border-darkBorder hover:border-neonGreen/50 rounded-2xl transition-all duration-300 hover:-translate-y-0.5 group overflow-hidden">
                ...
                <div class="relative p-4 flex items-center gap-3">
                    ...
                    <div class="flex flex-col min-w-0 flex-1">
                        ...
                        <p class="text-xl sm:text-2xl font-black text-slate-900 dark:text-white tracking-tight leading-none">{{ $totalTickets }}</p>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="bg-white dark:bg-darkCard border border-slate-200/80 dark:border-darkBorder rounded-2xl shadow-sm overflow-hidden hover:border-cyan-500/30 transition-all duration-300 hover:-translate-y-0.5 group">
                ...
                <div class="px-4 pt-4 pb-3">
                    <div class="flex items-start justify-between gap-3">
                        ...
                        {{-- Badge statut --}}
                        <span class="shrink-0 inline-flex items-center gap-1 px-2 py-0.5 rounded-full text-[9px] font-bold uppercase tracking-wider {{ $hotspot->statut === 'actif' ? 'bg-neonGreen/10 text-neonGreen dark:text-neonGreen-400' : 'bg-slate-100 dark:bg-slate-700/40 text-slate-400 dark:text-gray-500' }}">
                            <span class="w-1.5 h-1.5 rounded-full {{ $hotspot->statut === 'actif' ? 'bg-red-500 animate-pulse' : 'bg-slate-300 dark:bg-slate-600' }}"></span>
                            {{ $hotspot->statut === 'actif' ? 'En ligne' : 'Hors ligne' }}
                        </span>
                    </div>
                </div>
                ...
                <div class="px-4 pb-4 flex items-center gap-1.5">
                    ...
                    <button type="button" wire:click="confirmToggle({{ $hotspot->id }})"
                            class="w-8 h-8 rounded-xl flex items-center justify-center transition-all {{ $hotspot->statut === 'actif' ? 'bg-red-500/10 text-red-500 hover:bg-red-500 hover:text-white' : 'bg-slate-100 dark:bg-slate-700/40 text-slate-400 hover:bg-neonGreen hover:text-black' }}"
                            title="{{ $hotspot->statut === 'actif' ? 'Désactiver' : 'Activer' }}">
