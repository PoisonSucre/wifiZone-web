...
<div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-2 pb-1">
    <div class="flex items-center gap-3">
        <div class="relative w-10 h-10 sm:w-12 sm:h-12 rounded-2xl bg-gradient-to-br from-blue-500 via-blue-500/90 to-blue-400 flex items-center justify-center text-white text-base sm:text-lg shadow-[0_10px_30px_-10px_rgba(59,130,246,0.55)]">
        ...
        <div>
            ...
            <h2 class="text-xl sm:text-2xl font-extrabold text-slate-900 dark:text-white tracking-tight mt-0.5 sm:mt-1">Mes Tickets</h2>
        </div>
    </div>
    <div class="flex flex-wrap items-center gap-2">
        ...
        @endif
        <a href="{{ route('vendor.import') }}" class="inline-flex items-center gap-1.5 px-3 py-1.5 rounded-full bg-neonGreen hover:bg-neonGreen-600 text-white text-[10px] sm:text-[11px] font-bold transition-all shadow-sm hover:shadow-md">
