                    ...
                    <tr>
                        <td style="padding:40px;">
                            ...
                            <p style="margin:0 0 30px;color:#555;font-size:15px;line-height:1.7;text-align:center;">
                                Merci de votre inscription sur {{ config('platform.name') }}. Veuillez cliquer sur le bouton ci-dessous pour valider votre adresse email. Après vérification, vous aurez un accès immédiat à votre tableau de bord.
                            </p>
                            <div style="text-align:center;margin-bottom:30px;">
                                <a href="{{ $verificationUrl }}" style="display:inline-block;background-color:#8b5cf6;color:#ffffff;font-weight:700;font-size:15px;padding:14px 36px;border-radius:50px;text-decoration:none;box-shadow:0 4px 14px rgba(139,92,246,0.4);">
                                    Vérifier mon email
                                </a>
                            </div>
