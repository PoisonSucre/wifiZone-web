                    ...
                    <tr>
                        <td style="padding:40px;">
                            ...
                            <p style="margin:0 0 20px;color:#555;font-size:15px;line-height:1.7;text-align:center;">
                                <strong>{{ $vendeur->prenom }} {{ $vendeur->nom }}</strong> a soumis une demande de retrait.
                            </p>
                            ...
                            <div style="text-align:center;margin-bottom:20px;">
                                <a href="{{ url('/raider/retraits') }}" style="display:inline-block;background-color:#f59e0b;color:#ffffff;font-weight:700;font-size:15px;padding:14px 36px;border-radius:50px;text-decoration:none;box-shadow:0 4px 14px rgba(245,158,11,0.4);">
                                    Traiter la demande
                                </a>
                            </div>
                        </td>
