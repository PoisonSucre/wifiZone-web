...
<body style="margin:0;padding:0;background-color:#eef1f5;font-family:'Segoe UI',Roboto,Helvetica,Arial,sans-serif;">
    ...
    <div style="display:none;max-height:0;overflow:hidden;mso-hide:all;opacity:0;">
        Un compte administrateur a été créé pour vous sur {{ config('platform.name') }}. Cliquez sur le bouton pour définir votre mot de passe.
    </div>
                    ...
                    <tr>
                        <td class="email-padding" style="padding:44px 44px 36px;">
                            ...
                            <p style="margin:0 0 22px;color:#475569;font-size:15px;line-height:1.7;text-align:center;">
                                Bonjour <strong style="color:#0f172a;">{{ $admin->prenom }} {{ $admin->nom }}</strong>,<br>
                                un compte administrateur a été créé pour vous sur <strong style="color:#0f172a;">{{ config('platform.name') }}</strong>. Cliquez sur le bouton ci-dessous pour définir votre mot de passe et accéder à l'espace administrateur.
                            </p>
                            ...
                            <table role="presentation" cellpadding="0" cellspacing="0" align="center" style="margin:0 auto 20px;">
                                <tr>
                                    <td align="center" style="border-radius:10px;background-color:#059669;">
                                        <a href="{{ $setPasswordUrl }}" class="cta-button" style="display:inline-block;padding:15px 44px;color:#ffffff;font-size:15px;font-weight:600;text-decoration:none;border-radius:10px;">
