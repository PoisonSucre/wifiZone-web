                    ...
                    <div class="relative p-5 flex flex-col h-[calc(100%-2.25rem)]">
                        ...
                        <button type="button"
                                ...
                                class="mt-3 w-full inline-flex items-center justify-center gap-2 px-4 py-2.5 rounded-xl text-[11px] font-bold transition-all
                                       <?php echo e($hasSolde ? 'bg-neonGreen hover:bg-neonGreen-600 text-white' : 'bg-white/10 text-white/30 cursor-not-allowed'); ?>">
                        ...
                        <div class="p-4 space-y-3">
                                ...
                                <div class="flex items-center gap-2 min-w-0">
                                    ...
                                    <div class="min-w-0">
                                        <p class="text-xs font-bold text-slate-900 dark:text-white">
                                            <?php echo e($retrait->date_creation ? $retrait->date_creation->format('d/m/Y') : '-'); ?>

                                        </p>
                                        <p class="text-[10px] text-slate-400">
                                            <?php echo e($retrait->date_creation ? $retrait->date_creation->format('H:i') : ''); ?>

                                        </p>
                                    </div>
                                </div>
                                <span class="shrink-0 inline-flex items-center gap-1 px-2 py-0.5 rounded-md text-[10px] font-bold <?php echo e($statusStyle); ?>">
                            ...
                            <div class="flex items-center justify-between rounded-xl bg-neonGreen/5 border border-neonGreen/15 px-3 py-2.5">
                                ...
                                <span class="text-base font-black text-neonGreen tabular-nums leading-none">
                                    <?php echo e(number_format($retrait->montant_net, 0, ',', ' ')); ?> <span class="text-[10px]"><?php echo e($currency); ?></span>
                                </span>
                            </div>
                            ...
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($retrait->statut === 'rejected' && $retrait->note): ?>
                                <p class="text-[10px] text-red-500 dark:text-red-400"><?php echo e($retrait->note); ?></p>
                            <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                        </div>
                            ...
                            <tr class="border-b border-slate-50 dark:border-darkBorder/20 hover:bg-slate-50/70 dark:hover:bg-darkBg/40 transition-colors last:border-0 group">
                                ...
                                <td class="py-2.5 px-4 text-right">
                                    ...
                                    <div class="flex flex-col items-end gap-0.5">
                                        ...
                                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($retrait->statut === 'rejected' && $retrait->note): ?>
                                            <span class="text-[10px] text-red-500 dark:text-red-400 max-w-[180px] text-right truncate" title="<?php echo e($retrait->note); ?>"><?php echo e($retrait->note); ?></span>
                                        <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                    </div>
                                </td>
                            </tr>
                ...
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($hasSolde): ?>
                    ...
                    <div x-show="retraitStep === 1" class="grid grid-cols-2 gap-4">
                        <button type="button" @click="selectedOperator = 'orange'; retraitStep = 2" class="p-4 rounded-2xl border-2 border-slate-200 dark:border-darkBorder hover:border-neonGreen transition-all">
                            <img src="<?php echo e(asset('template/orange.png')); ?>" alt="Orange" class="w-full h-auto">
                        </button>
                        <button type="button" @click="selectedOperator = 'moov'; retraitStep = 2" class="p-4 rounded-2xl border-2 border-slate-200 dark:border-darkBorder hover:border-neonGreen transition-all">
                            <img src="<?php echo e(asset('template/moov.png')); ?>" alt="Moov" class="w-full h-auto">
                        </button>
                    </div>
