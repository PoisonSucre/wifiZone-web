            ...
            <div class="p-4 space-y-2.5">
                ...
                <div class="flex items-start justify-between gap-2">
                    <div class="min-w-0">
                        ...
                        <p class="text-sm font-bold text-slate-900 dark:text-white"><?php echo e(number_format($tx['montant'], 0, ',', ' ')); ?> FCFA</p>
                    </div>
                    <div class="text-right min-w-0">
                        ...
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($tx['phone_number']): ?>
                            <span class="font-mono text-xs text-slate-600 dark:text-gray-300 break-all"><?php echo e($tx['phone_number']); ?></span>
                        <?php else: ?>
