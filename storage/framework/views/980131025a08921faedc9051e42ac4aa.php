...
<body style="margin:0;padding:0;background-color:#eef1f5;font-family:'Segoe UI',Roboto,Helvetica,Arial,sans-serif;">
    ...
    <div style="display:none;max-height:0;overflow:hidden;mso-hide:all;opacity:0;">
        Votre demande d'inscription a bien été reçue&nbsp;! Votre compte est en attente d'approbation sur <?php echo e(config('platform.name')); ?>.
    </div>
                                    ...
                                    <tr>
                                        <td width="64" height="64" align="center" valign="middle" style="background-color:#e6f7f2;border-radius:50%;">
                                            <svg width="26" height="26" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                <circle cx="12" cy="12" r="8.5" stroke="#059669" stroke-width="1.8"/>
                                                <path d="M12 7.5V12L15 14" stroke="#059669" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"/>
                                            </svg>
                                        </td>
                                    </tr>
                                </table>
...
<?php /**PATH /home/mr_raider/Desktop/tickets/hotspot_sass_laravel/resources/views/emails/vendor-registered.blade.php ENDPATH**/ ?>