...
<head>
    ...
    <title>Votre compte vendeur a été activé</title>
</head>
                    ...
                    <tr>
                        <td style="padding:40px;">
                            ...
                            <p style="margin:0 0 20px;color:#555;font-size:15px;line-height:1.7;text-align:center;">
                                Nous avons le plaisir de vous informer que votre <strong>compte vendeur</strong> a été <strong style="color:#10B981;">activé</strong> avec succès !
                            </p>
                            <p style="margin:0 0 30px;color:#555;font-size:15px;line-height:1.7;text-align:center;">
                                Vous pouvez dès maintenant accéder à votre tableau de bord, configurer vos forfaits et commencer à vendre des tickets WiFi.
                            </p>
                            <div style="text-align:center;margin-bottom:30px;">
...
<?php /**PATH /home/mr_raider/Desktop/tickets/hotspot_sass_laravel/resources/views/emails/vendor-activated.blade.php ENDPATH**/ ?>