    ...
    <div x-show="loaded"
        ...
        <div class="bg-white dark:bg-darkCard border border-slate-200/80 dark:border-darkBorder rounded-2xl p-4">
            <div class="flex items-center justify-between">
                ...
                ?>
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $steps; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $num => $step): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                    <div class="flex items-center <?php echo e($num < 3 ? 'flex-1' : ''); ?>">
                        <div class="flex items-center gap-2 cursor-pointer"
                             wire:click="goToStep(<?php echo e($num); ?>)">
                            <div class="w-8 h-8 rounded-full flex items-center justify-center text-xs font-bold transition-all <?php echo e($currentStep === $num
                                ...
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($currentStep > $num): ?>
                                    <i class="fas fa-check text-[10px]"></i>
                                <?php else: ?>
                                    <i class="fas <?php echo e($step['icon']); ?> text-[10px]"></i>
                                <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                            </div>
                            <span class="text-[11px] font-bold hidden sm:inline <?php echo e($currentStep === $num ? 'text-slate-900 dark:text-white' : 'text-slate-400 dark:text-gray-500'); ?>"><?php echo e($step['label']); ?></span>
                        </div>
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($num < 3): ?>
                            <div class="flex-1 h-0.5 mx-2 rounded-full transition-all <?php echo e($currentStep > $num ? 'bg-neonGreen' : 'bg-slate-200 dark:bg-darkBorder'); ?>"></div>
                        <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                    </div>
        ...
        <div class="bg-white dark:bg-darkCard border border-slate-200/80 dark:border-darkBorder rounded-2xl shadow-sm overflow-hidden">
            ...
            <div class="p-4 space-y-4">
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 gap-2">
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $hotspots; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $hs): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                    <button type="button" wire:click="$set('hotspotId', <?php echo e($hs->id); ?>)"
                            class="flex items-center gap-3 p-3 rounded-xl border-2 transition-all text-left <?php echo e($hotspotId === $hs->id
                        ...
                        <div class="w-9 h-9 rounded-lg flex items-center justify-center <?php echo e($hotspotId === $hs->id ? 'bg-neonGreen text-white' : 'bg-slate-100 dark:bg-darkBg text-slate-400'); ?>">
                            <i class="fas fa-wifi text-xs"></i>
                        </div>
                        <div class="flex-1 min-w-0">
                            <p class="text-sm font-bold text-slate-900 dark:text-white truncate"><?php echo e($hs->name); ?></p>
                            <p class="text-[10px] text-slate-400 dark:text-gray-500"><?php echo e($hs->statut === 'actif' ? 'Actif' : 'Inactif'); ?></p>
                        </div>
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($hotspotId === $hs->id): ?>
                ...
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($hotspots->isEmpty()): ?>
                <div class="rounded-xl bg-amber-50 dark:bg-amber-900/10 border border-amber-200 dark:border-amber-800/40 p-4 text-center">
                    ...
                    <a href="<?php echo e(route('vendor.hotspot')); ?>" class="inline-flex items-center gap-1.5 px-4 py-2 rounded-xl bg-amber-500 hover:bg-amber-600 text-white text-xs font-bold transition-all">
                        <i class="fas fa-plus text-[10px]"></i> Créer un hotspot
                    </a>
                </div>
                <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>

                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__errorArgs = ['hotspotId'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> <p class="text-[10px] text-red-500 font-bold"><?php echo e($message); ?></p> <?php unset($message);
if (isset($__messageOriginal)) { $message = $__messageOriginal; }
endif;
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>

                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($hotspots->isNotEmpty()): ?>
                <div class="flex justify-end">
                    <button type="button" wire:click="nextStep"
                            <?php echo e($hotspotId <= 0 ? 'disabled' : ''); ?>
        ...
        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($hotspotPreselected && $currentStep > 1): ?>
        <div class="bg-neonGreen/5 border border-neonGreen/20 rounded-xl p-3 flex items-center gap-2.5">
            ...
            <div class="flex-1">
                ...
                <p class="text-sm font-bold text-slate-900 dark:text-white"><?php echo e($hotspots->firstWhere('id', $hotspotId)?->name ?? '—'); ?></p>
            </div>
        ...
        <div class="bg-white dark:bg-darkCard border border-slate-200/80 dark:border-darkBorder rounded-2xl shadow-sm overflow-hidden">
            ...
            <div class="p-4 space-y-4">
                ...
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($forfaits->isNotEmpty()): ?>
                <div class="grid grid-cols-1 sm:grid-cols-2 gap-2">
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $forfaits; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $fr): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                    <button type="button" wire:click="$set('forfaitId', <?php echo e($fr->id); ?>)"
                            class="flex items-center gap-3 p-3 rounded-xl border-2 transition-all text-left <?php echo e($forfaitId === $fr->id
                                    ? 'border-neonGreen bg-neonGreen/5'
                                    : 'border-slate-200 dark:border-darkBorder hover:border-slate-300 dark:hover:border-darkBorder/80'); ?>">
                        <div class="w-9 h-9 rounded-lg flex items-center justify-center <?php echo e($forfaitId === $fr->id ? 'bg-neonGreen text-white' : 'bg-slate-100 dark:bg-darkBg text-slate-400'); ?>">
                            <i class="fas fa-tag text-xs"></i>
                        </div>
                        <div class="flex-1 min-w-0">
                            <p class="text-sm font-bold text-slate-900 dark:text-white truncate"><?php echo e($fr->label); ?></p>
                            <p class="text-[10px] text-slate-400 dark:text-gray-500">
                                <?php echo e(number_format($fr->montant, 0, ',', ' ')); ?> <?php echo e($currency); ?> — <?php echo e($fr->formattedDuration()); ?>

                            </p>
                        </div>
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($forfaitId === $fr->id): ?>
                            <i class="fas fa-check-circle text-neonGreen text-sm"></i>
                        <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                    </button>
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::endLoop(); ?><?php endif; ?><?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::closeLoop(); ?><?php endif; ?>
                ...
                <div class="rounded-xl bg-amber-50 dark:bg-amber-900/10 border border-amber-200 dark:border-amber-800/40 p-4 text-center space-y-3">
                    ...
                    <a href="<?php echo e(route('vendor.boutique', ['hotspot' => $hotspotId, 'from' => 'import'])); ?>" class="inline-flex items-center gap-1.5 px-4 py-2 rounded-xl bg-amber-500 hover:bg-amber-600 text-white text-xs font-bold transition-all">
                        <i class="fas fa-plus text-[10px]"></i> Configurer un forfait
                    </a>
                </div>
                <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>

                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__errorArgs = ['forfaitId'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> <p class="text-[10px] text-red-500 font-bold"><?php echo e($message); ?></p> <?php unset($message);
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                ...
                <div class="flex justify-between">
                    <button type="button" wire:click="previousStep"
                            <?php if($hotspotPreselected): ?> wire:click="$set('currentStep', 1)" <?php endif; ?>
                    ...
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($forfaits->isNotEmpty()): ?>
                    <button type="button" wire:click="nextStep"
                            <?php echo e($forfaitId <= 0 ? 'disabled' : ''); ?>
                ...
                <div class="grid grid-cols-2 gap-2">
                    <div class="rounded-xl bg-slate-50 dark:bg-darkBg/60 border border-slate-100 dark:border-darkBorder/40 p-3">
                        ...
                        <p class="text-xs font-bold text-slate-900 dark:text-white truncate">
                            <?php echo e($hotspots->firstWhere('id', $hotspotId)?->name ?? '—'); ?>

                        </p>
                    </div>
                    <div class="rounded-xl bg-slate-50 dark:bg-darkBg/60 border border-slate-100 dark:border-darkBorder/40 p-3">
                        <p class="text-[9px] font-bold text-slate-400 dark:text-gray-500 uppercase tracking-widest mb-0.5">Forfait</p>
                        <?php $selFr = $forfaits->firstWhere('id', $forfaitId); ?>
                        <p class="text-xs font-bold text-slate-900 dark:text-white truncate">
                            <?php echo e($selFr?->label ?? '—'); ?>

                            <span class="text-slate-400 font-normal">· <?php echo e($selFr ? number_format($selFr->montant, 0, ',', ' ') . ' ' . $currency : ''); ?></span>
                        </p>
                    </div>
                </div>
                    ...
                    <div class="flex items-start gap-2.5">
                        ...
                        <div class="flex-1 space-y-1.5">
                            ...
                            <p class="text-[11px] text-amber-600 dark:text-amber-400/90 leading-relaxed">
                                Tous les tickets de ce fichier seront importés avec le forfait <strong><?php echo e($selFr?->label ?? '—'); ?></strong> au prix de <strong><?php echo e($selFr ? number_format($selFr->montant, 0, ',', ' ') . ' ' . $currency : '—'); ?></strong>.
                            </p>
                            <p class="text-[11px] text-amber-600 dark:text-amber-400/90 leading-relaxed">
                            ...
                            <div class="flex items-center gap-2 pt-1">
                                <span class="inline-flex items-center gap-1 px-2 py-1 rounded-lg bg-amber-100 dark:bg-amber-800/30 text-amber-700 dark:text-amber-400 text-[10px] font-bold">
                                    <i class="fas fa-ticket text-[9px]"></i> Profil Mikhmon : <strong><?php echo e($selFr?->label ?? '—'); ?></strong>
                                </span>
                                <span class="inline-flex items-center gap-1 px-2 py-1 rounded-lg bg-amber-100 dark:bg-amber-800/30 text-amber-700 dark:text-amber-400 text-[10px] font-bold">
                                    <i class="fas fa-clock text-[9px]"></i> Durée : <strong><?php echo e($selFr?->formattedDuration() ?? '—'); ?></strong>
                                </span>
                            </div>
                        </div>
                    </div>
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                ...
                <div class="flex items-center justify-between gap-3">
                    ...
                    <button wire:click="importFile" wire:loading.attr="disabled"
                            <?php echo e(!$importFile ? 'disabled' : ''); ?>
                ...
                <div x-transition:enter="transition ease-out duration-300"
                     ...
                     class="p-4 rounded-xl text-xs font-bold border <?php echo e($importSuccess ? 'bg-emerald-50 dark:bg-neonGreen/10 border-emerald-200 dark:border-neonGreen/20 text-emerald-700 dark:text-neonGreen' : 'bg-red-50 dark:bg-red-500/10 border-red-200 dark:border-red-500/20 text-red-700 dark:text-red-400'); ?>">
                    <div class="flex items-center gap-2 mb-2">
                        <i class="fas <?php echo e($importSuccess ? 'fa-check-circle' : 'fa-exclamation-circle'); ?> text-sm"></i>
                        <span><?php echo e($importResult); ?></span>
                    </div>
        ...
        <div class="bg-white dark:bg-darkCard border border-slate-200/80 dark:border-darkBorder rounded-2xl shadow-sm overflow-hidden">
            ...
            <div class="p-4 space-y-2.5">
                ...
                ?>
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $guideSteps; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $i => $step): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                    <div class="flex items-start gap-2.5">
                        <span class="shrink-0 w-5 h-5 rounded-full bg-blue-100 dark:bg-blue-500/20 text-blue-600 dark:text-blue-400 text-[10px] font-bold flex items-center justify-center mt-0.5"><?php echo e($i + 1); ?></span>
                        <span class="text-xs text-slate-600 dark:text-gray-400 leading-relaxed"><?php echo $step; ?></span>
                    </div>
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::endLoop(); ?><?php endif; ?><?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::closeLoop(); ?><?php endif; ?>
            </div>
        </div>
...
<?php /**PATH /home/mr_raider/Desktop/tickets/hotspot_sass_laravel/resources/views/livewire/vendor/ticket-import.blade.php ENDPATH**/ ?>