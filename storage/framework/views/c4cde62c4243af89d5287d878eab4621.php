    ...
    <section id="packs" class="py-16 sm:py-24 bg-white dark:bg-darkBg transition-colors duration-300">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-6 sm:gap-8">
                ...
                <div class="relative rounded-3xl bg-white dark:bg-darkCard border border-slate-200 dark:border-darkBorder hover:border-neonGreen/30 transition-all hover:shadow-neon-glow hover:-translate-y-1 group shadow-sm <?php echo e($pack['populaire'] ? 'ring-2 ring-neonGreen/20' : ''); ?>">
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($pack['populaire']): ?>
                    ...
                    <div class="p-6 sm:p-8">
                        <div class="w-14 h-14 rounded-2xl flex items-center justify-center text-white text-xl font-bold mb-6" style="background: <?php echo e($pack['couleur']); ?>">
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($pack['id'] === 'starter'): ?>
                                <i class="fas fa-seedling"></i>
                            <?php elseif($pack['id'] === 'pro'): ?>
                                <i class="fas fa-rocket"></i>
                            <?php else: ?>
                                <i class="fas fa-building"></i>
                            <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                        </div>
                        <h3 class="text-lg sm:text-xl font-bold text-slate-900 dark:text-white mb-1"><?php echo e($pack['nom']); ?></h3>
                        <p class="text-slate-600 dark:text-gray-400 text-sm mb-6"><?php echo e($pack['sousTitre']); ?></p>

                        <div class="mb-6">
                            <span class="font-display text-3xl font-extrabold text-slate-900 dark:text-white" style="color: <?php echo e($pack['couleur']); ?>"><?php echo e($pack['prix']); ?></span>
                            ...
                            <span class="text-slate-500 dark:text-gray-500 font-semibold ml-1"><?php echo e($pack['prixNote']); ?></span>
                            <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                        </div>
                    ...
                    <div class="px-6 pb-6">
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($pack['id'] === 'enterprise'): ?>
                        <a href="<?php echo e(route('contact')); ?>" class="w-full inline-flex items-center justify-center gap-2 px-4 py-3 rounded-xl font-bold text-sm transition-all" style="background: <?php echo e($pack['couleur']); ?>; color: white">
                            <i class="fas fa-comments"></i> Demander un devis
                        </a>
                        <?php else: ?>
                        <button @click="selectedPack = '<?php echo e($pack['id']); ?>'" class="w-full inline-flex items-center justify-center gap-2 px-4 py-3 rounded-xl font-bold text-sm transition-all <?php echo e('selectedPack === \'' . $pack['id'] . '\' ? \'text-white\' : \'text-slate-700 dark:text-gray-300 bg-slate-100 dark:bg-darkBorder/40 hover:bg-slate-200 dark:hover:bg-darkBorder/60\'); ?>" :style="selectedPack === '<?php echo e($pack['id']); ?>' ? 'background: <?php echo e($pack['couleur']); ?>' : ''">
...
</script><?php /**PATH /home/mr_raider/Desktop/tickets/hotspot_sass_laravel/resources/views/livewire/installation/installation-page.blade.php ENDPATH**/ ?>