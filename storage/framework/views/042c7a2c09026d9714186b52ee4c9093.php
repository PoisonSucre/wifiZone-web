                ...
                <table width="600" cellpadding="0" cellspacing="0" style="background-color:#ffffff;border-radius:12px;overflow:hidden;box-shadow:0 2px 12px rgba(0,0,0,0.08);">
                    ...
                    <tr>
                        <td style="padding:40px;">
                            ...
                            <h2 style="margin:0 0 15px;color:#1a1a2e;font-size:20px;text-align:center;">Bonjour <?php echo e($vendeur->prenom); ?> <?php echo e($vendeur->nom); ?>,</h2>
                            <p style="margin:0 0 20px;color:#555;font-size:15px;line-height:1.7;text-align:center;">
                                Nous vous informons que votre <strong>compte vendeur</strong> a été <strong style="color:#ef4444;">suspendu</strong>.
                            </p>
                            ...
                            <div style="text-align:center;margin-bottom:30px;">
                                <a href="<?php echo e(url('/contact')); ?>" style="display:inline-block;background-color:#ef4444;color:#ffffff;font-weight:700;font-size:15px;padding:14px 36px;border-radius:50px;text-decoration:none;box-shadow:0 4px 14px rgba(239,68,68,0.4);">
