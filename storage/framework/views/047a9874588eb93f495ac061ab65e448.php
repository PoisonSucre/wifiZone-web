...
<?php $__env->startSection('title', 'Détails des Revenus'); ?>
...
<div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-2">
    ...
    <div class="flex items-center gap-2 mt-1 sm:mt-0">
        <a href="<?php echo e(route('admin.dashboard')); ?>" class="inline-flex items-center gap-1.5 px-3 py-1.5 rounded-lg bg-slate-800 dark:bg-slate-700 text-white hover:bg-slate-900 text-xs font-bold transition-all">
    ...
    <div class="space-y-4 sm:space-y-5">
        <div class="grid grid-cols-2 sm:grid-cols-4 gap-3">
            ...
            <div class="relative bg-white dark:bg-darkCard border border-slate-200/80 dark:border-darkBorder hover:border-neonGreen/50 rounded-2xl transition-all duration-300 hover:-translate-y-0.5 hover:shadow-[0_10px_30px_-12px_rgba(0,255,136,0.35)] group overflow-hidden">
                ...
                <div class="relative pointer-events-none"><?php echo $stats->sparkline($periodData['7j']['revenus'], $C['neon'], 28, 'rd-rev'); ?></div>
            </div>
            ...
            <div class="relative bg-white dark:bg-darkCard border border-slate-200/80 dark:border-darkBorder hover:border-teal-500/50 rounded-2xl transition-all duration-300 hover:-translate-y-0.5 hover:shadow-[0_10px_30px_-12px_rgba(20,184,166,0.35)] group overflow-hidden">
                ...
                <div class="relative p-4 flex items-center gap-3">
                    ...
                    <div class="flex flex-col min-w-0 flex-1">
                        ...
                        <p class="text-lg sm:text-xl font-black text-slate-900 dark:text-white tracking-tight leading-none flex items-baseline gap-1">
                            <?php echo e(number_format($totalCommissions, 0, ',', ' ')); ?> <span class="text-[10px] text-slate-400 font-bold"><?php echo e($currency); ?></span>
                        </p>
                    </div>
                </div>
                <div class="relative pointer-events-none"><?php echo $stats->sparkline($periodData['7j']['commissions'], $C['teal'], 28, 'rd-com'); ?></div>
            </div>
            ...
            <div class="relative bg-white dark:bg-darkCard border border-slate-200/80 dark:border-darkBorder hover:border-amber-500/50 rounded-2xl transition-all duration-300 hover:-translate-y-0.5 hover:shadow-[0_10px_30px_-12px_rgba(245,158,11,0.35)] group overflow-hidden">
                ...
                <div class="relative p-4 flex items-center gap-3">
                    ...
                    <div class="flex flex-col min-w-0 flex-1">
                        ...
                        <p class="text-lg sm:text-xl font-black tracking-tight leading-none <?php echo e($evoRevenus >= 0 ? 'text-emerald-500' : 'text-red-500'); ?>">
                            <?php echo e($evoRevenus >= 0 ? '+' : ''); ?><?php echo e($evoRevenus); ?>%
                        </p>
                    </div>
                </div>
                <div class="relative pointer-events-none"><?php echo $stats->sparkline($periodData['7j']['revenus'], $C['amber'], 28, 'rd-evor'); ?></div>
            </div>
            ...
            <div class="relative bg-white dark:bg-darkCard border border-slate-200/80 dark:border-darkBorder hover:border-orange-500/50 rounded-2xl transition-all duration-300 hover:-translate-y-0.5 hover:shadow-[0_10px_30px_-12px_rgba(249,115,22,0.35)] group overflow-hidden">
                ...
                <div class="relative p-4 flex items-center gap-3">
                    ...
                    <div class="flex flex-col min-w-0 flex-1">
                        ...
                        <p class="text-lg sm:text-xl font-black tracking-tight leading-none <?php echo e($evoCommissions >= 0 ? 'text-emerald-500' : 'text-red-500'); ?>">
                            <?php echo e($evoCommissions >= 0 ? '+' : ''); ?><?php echo e($evoCommissions); ?>%
                        </p>
                    </div>
                </div>
                <div class="relative pointer-events-none"><?php echo $stats->sparkline($periodData['7j']['commissions'], $C['orange'], 28, 'rd-evoc'); ?></div>
            </div>
        </div>
        ...
        <div class="bg-white dark:bg-darkCard border border-slate-200/80 dark:border-darkBorder rounded-2xl p-4 sm:p-5 shadow-sm" x-data="{ period: '7j' }">
            <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3 mb-4">
                ...
                <div class="inline-flex p-0.5 rounded-full bg-slate-100 dark:bg-darkBg border border-slate-200/80 dark:border-darkBorder">
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = ['7j', '30j', '90j']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $p): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                        <button @click="period = '<?php echo e($p); ?>'; window.updateRevenueChart('<?php echo e($p); ?>')"
                                :class="period === '<?php echo e($p); ?>' ? 'bg-white dark:bg-darkCard text-slate-900 dark:text-white shadow-sm' : 'text-slate-500 dark:text-gray-400 hover:text-slate-700 dark:hover:text-gray-300'"
            ...
            <div class="overflow-x-auto">
                <table class="w-full text-left border-collapse">
                    ...
                    <tbody class="text-xs text-slate-700 dark:text-gray-300">
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $d7['labels']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $i => $label): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                            <tr class="border-b border-slate-50 dark:border-darkBorder/20 hover:bg-slate-50/70 dark:hover:bg-darkBg/40 transition-colors last:border-0">
                                <td class="py-2.5 px-4 font-bold text-slate-900 dark:text-white"><?php echo e($label); ?></td>
                                <td class="py-2.5 px-4 text-right font-black text-neonGreen">
                                    <?php echo e(number_format($d7['revenus'][$i], 0, ',', ' ')); ?> <span class="text-[9px] text-slate-400"><?php echo e($currency); ?></span>
                                </td>
                                <td class="py-2.5 px-4 text-right font-black text-amber-500">
                                    <?php echo e(number_format($d7['commissions'][$i], 0, ',', ' ')); ?> <span class="text-[9px] text-slate-400"><?php echo e($currency); ?></span>
                                </td>
                            </tr>
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::endLoop(); ?><?php endif; ?><?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::closeLoop(); ?><?php endif; ?>
                    </tbody>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    const allData = <?php echo json_encode($periodData, 15, 512) ?>;
        ...
        options: {
            ...
            plugins: {
                ...
                tooltip: {
                    ...
                    callbacks: {
                        label: function (c) {
                            return '  ' + c.dataset.label + ' : ' + new Intl.NumberFormat('fr-FR').format(c.parsed.y) + ' <?php echo e($currency); ?>';
                        },
                    },
                },
            },
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/mr_raider/Desktop/tickets/hotspot_sass_laravel/resources/views/admin/revenus-details.blade.php ENDPATH**/ ?>