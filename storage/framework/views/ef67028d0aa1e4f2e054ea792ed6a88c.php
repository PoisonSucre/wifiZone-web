...
<body style="margin:0;padding:0;background-color:#eef1f5;font-family:'Segoe UI',Roboto,Helvetica,Arial,sans-serif;">
    ...
    <div style="display:none;max-height:0;overflow:hidden;mso-hide:all;opacity:0;">
        Un nouveau vendeur s'est inscrit sur <?php echo e(config('platform.name')); ?> et attend votre validation.
    </div>
                    ...
                    <tr>
                        <td class="email-padding" style="padding:44px 44px 36px;">
                                    ...
                                    <tr>
                                        <td width="64" height="64" align="center" valign="middle" style="background-color:#e6f7f2;border-radius:50%;">
                                            <svg width="26" height="26" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                <circle cx="10" cy="8" r="3.5" stroke="#059669" stroke-width="1.8"/>
                                                <path d="M4.5 19C4.5 15.5 7 13.5 10 13.5C13 13.5 15.5 15.5 15.5 19" stroke="#059669" stroke-width="1.8" stroke-linecap="round"/>
                                                <path d="M18 8V14M15 11H21" stroke="#059669" stroke-width="1.8" stroke-linecap="round"/>
                                            </svg>
                                        </td>
                                    </tr>
                                </table>
                            ...
                            <h1 class="h2-title" style="margin:0 0 14px;color:#0f172a;font-size:21px;font-weight:700;text-align:center;line-height:1.3;">
                                Un nouveau vendeur s'est inscrit
                            </h1>

                            <p style="margin:0 0 22px;color:#475569;font-size:15px;line-height:1.7;text-align:center;">
                                Un nouveau vendeur vient de s'inscrire sur la plateforme et attend votre validation.
                            </p>
                            ...
                            <table role="presentation" width="100%" cellpadding="0" cellspacing="0" style="background-color:#e6f7f2;border:1px solid #a7e3cf;border-radius:10px;margin-bottom:25px;">
                                <tr>
                                    <td style="padding:18px 22px;">
                                        <p style="margin:0 0 10px;color:#065f46;font-size:14px;font-weight:700;">Informations :</p>
                                        <p style="margin:0;color:#065f46;font-size:13px;line-height:1.8;">
                                            Nom : <strong><?php echo e($vendeur->prenom); ?> <?php echo e($vendeur->nom); ?></strong><br>
                                            Email : <strong><?php echo e($vendeur->email); ?></strong><br>
                                            Téléphone : <strong><?php echo e($vendeur->telephone); ?></strong>
                                        </p>
                                    </td>
                                </tr>
                            </table>
                            ...
                            <table role="presentation" cellpadding="0" cellspacing="0" align="center" style="margin:0 auto 20px;">
                                <tr>
                                    <td align="center" style="border-radius:10px;background-color:#059669;">
                                        <a href="<?php echo e(url('/raider/vendeurs')); ?>" class="cta-button" style="display:inline-block;padding:15px 44px;color:#ffffff;font-size:15px;font-weight:600;text-decoration:none;border-radius:10px;">
...
<?php /**PATH /home/mr_raider/Desktop/tickets/hotspot_sass_laravel/resources/views/emails/admin-vendor-registered.blade.php ENDPATH**/ ?>