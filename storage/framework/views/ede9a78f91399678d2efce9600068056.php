...
<body style="margin:0;padding:0;background-color:#eef1f5;font-family:'Segoe UI',Roboto,Helvetica,Arial,sans-serif;">
    ...
    <div style="display:none;max-height:0;overflow:hidden;mso-hide:all;opacity:0;">
        Votre retrait de <?php echo e(number_format($withdrawal->montant_net, 0, ',', ' ')); ?> <?php echo e(config('platform.currency')); ?> a été versé sur votre numéro.
    </div>
                    ...
                    <tr>
                        <td class="email-padding" style="padding:44px 44px 36px;">
                            ...
                            <p style="margin:0 0 22px;color:#475569;font-size:15px;line-height:1.7;text-align:center;">
                                ...
                                votre retrait de <strong style="color:#059669;"><?php echo e(number_format($withdrawal->montant_net, 0, ',', ' ')); ?> <?php echo e(config('platform.currency')); ?></strong> a été versé sur le numéro <strong><?php echo e($withdrawal->phone_number); ?></strong>.
                            </p>
...
<?php /**PATH /home/mr_raider/Desktop/tickets/hotspot_sass_laravel/resources/views/emails/withdrawal-paid.blade.php ENDPATH**/ ?>