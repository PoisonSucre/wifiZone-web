...
<div x-data="{ loaded: false, apparenceOpen: true, forfaitsOpen: true }" x-cloak
    ...
    <div x-show="loaded"
        ...
        <div class="relative overflow-hidden rounded-2xl border shadow-sm <?php echo e($portalReady ? 'bg-gradient-to-br from-neonGreen/10 via-emerald-500/5 to-transparent border-neonGreen/30 dark:border-neonGreen/20' : 'bg-gradient-to-br from-amber-50 to-amber-50/30 dark:from-amber-900/10 dark:to-transparent border-amber-300/60 dark:border-amber-700/30'); ?>">
            <div class="absolute -right-8 -top-8 w-32 h-32 rounded-full <?php echo e($portalReady ? 'bg-neonGreen/10' : 'bg-amber-400/10'); ?> blur-2xl"></div>
            <div class="relative p-4 sm:p-5">
                <div class="flex items-center gap-2.5 mb-2">
                    <div class="w-9 h-9 rounded-xl <?php echo e($portalReady ? 'bg-neonGreen/15 text-neonGreen' : 'bg-amber-400/15 text-amber-600 dark:text-amber-400'); ?> flex items-center justify-center shrink-0">
                        <i class="fas <?php echo e($portalReady ? 'fa-share-alt' : 'fa-exclamation-triangle'); ?> text-sm"></i>
                    </div>
                    <div>
                ...
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($portalReady): ?>
                ...
                <?php else: ?>
                    <div class="rounded-xl bg-amber-100/60 dark:bg-amber-900/20 border border-amber-300/50 dark:border-amber-700/30 p-3 mb-3">
                        ...
                        <ul class="text-[11px] text-amber-700 dark:text-amber-400/90 leading-relaxed space-y-1 list-disc list-inside">
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $portalMissingSteps; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $step): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                    ...
                    <div class="flex items-center gap-2 opacity-50 cursor-not-allowed">
                        <input type="text" value="<?php echo e($shopLink); ?>" readonly
            ...
            <div class="relative bg-white dark:bg-darkCard border border-slate-200/80 dark:border-darkBorder hover:border-neonGreen/50 rounded-2xl transition-all duration-300 hover:-translate-y-0.5 group overflow-hidden">
                ...
                <div class="relative p-4 flex items-center gap-3">
                    ...
                    <div class="flex flex-col min-w-0 flex-1">
                        ...
                        <p class="text-lg sm:text-2xl font-black text-slate-900 dark:text-white tracking-tight leading-none"><?php echo e($nbForfaits); ?></p>
                    </div>
                </div>
            </div>
            ...
            <div class="relative bg-white dark:bg-darkCard border border-slate-200/80 dark:border-darkBorder hover:border-blue-500/50 rounded-2xl transition-all duration-300 hover:-translate-y-0.5 group overflow-hidden">
                ...
                <div class="relative p-4 flex items-center gap-3">
                    ...
                    <div class="flex flex-col min-w-0 flex-1">
                        ...
                        <p class="text-lg sm:text-2xl font-black text-blue-600 dark:text-blue-400 tracking-tight leading-none"><?php echo e($nbActifs); ?></p>
                    </div>
                </div>
            </div>
            ...
            <div class="relative bg-white dark:bg-darkCard border border-slate-200/80 dark:border-darkBorder hover:border-amber-500/50 rounded-2xl transition-all duration-300 hover:-translate-y-0.5 group overflow-hidden">
                ...
                <div class="relative p-4 flex items-center gap-3">
                    ...
                    <div class="flex flex-col min-w-0 flex-1">
                        ...
                        <p class="text-lg sm:text-2xl font-black text-amber-600 dark:text-amber-400 tracking-tight leading-none"><?php echo e($nbForfaits - $nbActifs); ?></p>
                    </div>
                </div>
            </div>
                        ...
                        <div class="space-y-2 mb-4">
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = $forfaits; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $forfait): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                                <div class="flex items-center gap-3 p-3 rounded-xl bg-slate-50/70 dark:bg-darkBg/50 border border-slate-100 dark:border-darkBorder/40 hover:border-neonGreen/30 transition-all group">
                                    ...
                                    <span class="text-[11px] sm:text-xs font-black text-slate-900 dark:text-white whitespace-nowrap"><?php echo e(number_format($forfait->montant, 0, ',', ' ')); ?></span>
                                    <div class="flex items-center gap-1 shrink-0">
                                        <button type="button" wire:click="toggleForfait(<?php echo e($forfait->id); ?>)"
                                                class="w-6 h-6 sm:w-7 sm:h-7 rounded-lg flex items-center justify-center transition-all <?php echo e($forfait->actif ? 'bg-blue-500/10 text-blue-500 hover:bg-blue-500 hover:text-white' : 'bg-slate-100 dark:bg-slate-700/40 text-slate-400 hover:bg-amber-500 hover:text-white'); ?>">
...
<?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::processComponentKey($component); ?>
             ...
             <?php $__env->slot('header', null, []); ?> 
                <?php if (isset($component)) { $__componentOriginal436399e29d00ce6b8f47e38277d39536 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal436399e29d00ce6b8f47e38277d39536 = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.section-header','data' => ['icon' => 'download','color' => 'purple']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('section-header'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['icon' => 'download','color' => 'purple']); ?>
<?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::processComponentKey($component); ?>
Pack MikroTik <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginal436399e29d00ce6b8f47e38277d39536)): ?>
<?php $attributes = $__attributesOriginal436399e29d00ce6b8f47e38277d39536; ?>
<?php unset($__attributesOriginal436399e29d00ce6b8f47e38277d39536); ?>
