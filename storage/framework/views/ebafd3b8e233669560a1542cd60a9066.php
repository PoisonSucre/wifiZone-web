<div wire:poll.3s="pollStatus"
     ...
     @redirect-to-pending.window="window.location = '<?php echo e(route('vendor.pending')); ?>'">
    ...
    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($status === 'suspendu'): ?>
...
<?php /**PATH /home/mr_raider/Desktop/tickets/hotspot_sass_laravel/resources/views/livewire/auth/suspended-status.blade.php ENDPATH**/ ?>