<?php $__env->startSection('title', 'Mot de passe oublié — Admin'); ?>
...
<div class="max-w-md w-full bg-white dark:bg-darkCard border border-slate-200 dark:border-darkBorder rounded-3xl p-6 sm:p-10 shadow-xl transition-all duration-300">
    <div class="text-center mb-8">
        ...
        <p class="text-sm text-slate-500 dark:text-gray-400">Espace administrateur — entrez votre email pour recevoir un lien.</p>
    </div>
    ...
    <form method="POST" action="<?php echo e(route('admin.forgot-password.post')); ?>" class="space-y-5">
        <?php echo csrf_field(); ?>
        <div>
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
    ...
    <div class="mt-4 pt-4 border-t border-slate-100 dark:border-darkBorder/40 text-center">
        <a href="<?php echo e(route('admin.login')); ?>" class="text-sm font-bold text-neonGreen hover:text-neonGreen-400 transition-colors">
...
<?php echo $__env->make('layouts.auth', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/mr_raider/Desktop/tickets/hotspot_sass_laravel/resources/views/auth/admin-forgot-password.blade.php ENDPATH**/ ?>