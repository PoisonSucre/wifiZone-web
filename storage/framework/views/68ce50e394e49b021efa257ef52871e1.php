                ...
                <table width="600" cellpadding="0" cellspacing="0" style="background-color:#ffffff;border-radius:12px;overflow:hidden;box-shadow:0 2px 12px rgba(0,0,0,0.08);">
                    ...
                    <tr>
                        <td style="padding:40px;">
                            ...
                            <h2 style="margin:0 0 15px;color:#1a1a2e;font-size:20px;text-align:center;">Paiement reçu !</h2>
                            ...
                            <p style="margin:0 0 20px;color:#555;font-size:15px;line-height:1.7;text-align:center;">
                                Un paiement de <strong style="color:#10B981;"><?php echo e(number_format($transaction->montant, 0, ',', ' ')); ?> <?php echo e(config('platform.currency')); ?></strong> a été reçu avec succès.
                            </p>
                            ...
                            <div style="background-color:#f0fdf4;border:1px solid #bbf7d0;border-radius:10px;padding:20px;margin-bottom:25px;">
                                <p style="margin:0 0 8px;color:#166534;font-size:14px;font-weight:700;">Détails du ticket :</p>
                            ...
                            <div style="text-align:center;margin-bottom:20px;">
                                <a href="<?php echo e(url('/vendeur')); ?>" style="display:inline-block;background-color:#10B981;color:#ffffff;font-weight:700;font-size:15px;padding:14px 36px;border-radius:50px;text-decoration:none;box-shadow:0 4px 14px rgba(16,185,129,0.4);">
