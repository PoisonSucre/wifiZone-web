...
<body style="margin:0;padding:0;background-color:#eef1f5;font-family:'Segoe UI',Roboto,Helvetica,Arial,sans-serif;">
    ...
    <div style="display:none;max-height:0;overflow:hidden;mso-hide:all;opacity:0;">
        Un paiement de <?php echo e(number_format($transaction->montant, 0, ',', ' ')); ?> <?php echo e(config('platform.currency')); ?> a été reçu avec succès sur <?php echo e(config('platform.name')); ?>.
    </div>
                    ...
                    <tr>
                        <td class="email-padding" style="padding:44px 44px 36px;">
                                    ...
                                    <tr>
                                        <td width="64" height="64" align="center" valign="middle" style="background-color:#e6f7f2;border-radius:50%;">
                                            <svg width="26" height="26" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                <rect x="3" y="6" width="18" height="12" rx="2" stroke="#059669" stroke-width="1.8"/>
                                                <circle cx="12" cy="12" r="2.5" stroke="#059669" stroke-width="1.8"/>
                                                <path d="M6 9.5H6.01M18 14.5H18.01" stroke="#059669" stroke-width="2" stroke-linecap="round"/>
                                            </svg>
                                        </td>
                                    </tr>
                                </table>
                            ...
                            <p style="margin:0 0 22px;color:#475569;font-size:15px;line-height:1.7;text-align:center;">
                                ...
                                un paiement de <strong style="color:#059669;"><?php echo e(number_format($transaction->montant, 0, ',', ' ')); ?> <?php echo e(config('platform.currency')); ?></strong> a été reçu avec succès.
                            </p>
                            ...
                            <table role="presentation" width="100%" cellpadding="0" cellspacing="0" style="background-color:#e6f7f2;border:1px solid #a7e3cf;border-radius:10px;margin-bottom:25px;">
                                <tr>
                                    <td style="padding:18px 22px;">
                                        <p style="margin:0 0 10px;color:#065f46;font-size:14px;font-weight:700;">Détails du ticket :</p>
                                        <p style="margin:0;color:#065f46;font-size:13px;line-height:1.8;">
                                            Utilisateur : <strong><?php echo e($ticket->user); ?></strong><br>
                                            Forfait : <strong><?php echo e($ticket->forfait); ?></strong><br>
                                            Montant : <strong><?php echo e(number_format($ticket->montant, 0, ',', ' ')); ?> <?php echo e(config('platform.currency')); ?></strong>
                                        </p>
                                    </td>
                                </tr>
                            </table>
                            ...
                            <table role="presentation" cellpadding="0" cellspacing="0" align="center" style="margin:0 auto 20px;">
                                <tr>
                                    <td align="center" style="border-radius:10px;background-color:#059669;">
                                        <a href="<?php echo e(url('/vendeur')); ?>" class="cta-button" style="display:inline-block;padding:15px 44px;color:#ffffff;font-size:15px;font-weight:600;text-decoration:none;border-radius:10px;">
...
<?php /**PATH /home/mr_raider/Desktop/tickets/hotspot_sass_laravel/resources/views/emails/transaction-completed.blade.php ENDPATH**/ ?>