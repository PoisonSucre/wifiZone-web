...
<div class="max-w-md w-full bg-white dark:bg-darkCard border border-slate-200 dark:border-darkBorder rounded-3xl p-6 sm:p-10 shadow-xl transition-all duration-300">
    ...
    <form method="POST" action="<?php echo e(route('vendor.forgot-password.post')); ?>" class="space-y-5">
        <?php echo csrf_field(); ?>
        <div>
...
<?php echo $__env->make('layouts.auth', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/mr_raider/Desktop/tickets/hotspot_sass_laravel/resources/views/auth/forgot-password.blade.php ENDPATH**/ ?>