...
<head>
    ...
    <title>Création de votre mot de passe administrateur</title>
    <!--[if mso]>
    <noscript>
        <xml>
...
<body style="margin:0;padding:0;background-color:#eef1f5;font-family:'Segoe UI',Roboto,Helvetica,Arial,sans-serif;">
    ...
    <div style="display:none;max-height:0;overflow:hidden;mso-hide:all;opacity:0;">
        Un compte administrateur a été créé pour vous sur <?php echo e(config('platform.name')); ?>. Cliquez sur le bouton pour définir votre mot de passe.
    </div>
                    ...
                    <tr>
                        <td class="email-padding" style="padding:44px 44px 36px;">
                                    ...
                                    <tr>
                                        <td width="64" height="64" align="center" valign="middle" style="background-color:#e6f7f2;border-radius:50%;">
                                            <svg width="26" height="26" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                <rect x="4" y="10" width="16" height="10" rx="2" stroke="#059669" stroke-width="1.8"/>
                                                <path d="M8 10V8a4 4 0 0 1 8 0v2" stroke="#059669" stroke-width="1.8" stroke-linecap="round"/>
                                                <circle cx="12" cy="15" r="1.6" fill="#059669"/>
                                            </svg>
                                        </td>
                                    </tr>
                                </table>
                            ...
                            <p style="margin:0 0 22px;color:#475569;font-size:15px;line-height:1.7;text-align:center;">
                                Bonjour <strong style="color:#0f172a;"><?php echo e($admin->prenom); ?> <?php echo e($admin->nom); ?></strong>,<br>
                                un compte administrateur a été créé pour vous sur <strong style="color:#0f172a;"><?php echo e(config('platform.name')); ?></strong>. Cliquez sur le bouton ci-dessous pour définir votre mot de passe et accéder à l'espace administrateur.
                            </p>
                            ...
                            <table role="presentation" cellpadding="0" cellspacing="0" align="center" style="margin:0 auto 20px;">
                                <tr>
                                    <td align="center" style="border-radius:10px;background-color:#059669;">
                                        <a href="<?php echo e($setPasswordUrl); ?>" class="cta-button" style="display:inline-block;padding:15px 44px;color:#ffffff;font-size:15px;font-weight:600;text-decoration:none;border-radius:10px;">
...
<?php /**PATH /home/mr_raider/Desktop/tickets/hotspot_sass_laravel/resources/views/emails/admin-set-password.blade.php ENDPATH**/ ?>