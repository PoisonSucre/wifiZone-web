...
#main .brand {
    ...
    border: #fff solid;
    border-radius: 25px;
    background-image: url('<?php echo e(asset("template/boom.gif")); ?>');
...
<?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
    <div id="main" class="main">
        ...
        <div class="box">
            <img src="<?php echo e(asset($vendeur->logo)); ?>" style="max-width:80px;max-height:60px;border-radius:10px;display:block;margin:0 auto 10px" alt="Logo">
        </div>
        <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
