...
<head>
    ...
    <title>404 — Page introuvable | <?php echo e(config('platform.name')); ?></title>
    ...
    <div class="w-full max-w-md">
        <div class="bg-white dark:bg-darkCard border border-slate-200 dark:border-darkBorder rounded-3xl p-8 sm:p-10 shadow-sm text-center">
            ...
            <div class="space-y-3">
                ...
                <a href="mailto:<?php echo e(config('platform.support_email')); ?>"
        ...
        <p class="text-center mt-6 text-xs text-slate-400 dark:text-gray-500">
            <?php echo e(config('platform.name')); ?> — Designed by Raider Corporation
        </p>
    </div>
</body>
</html>
<?php /**PATH /home/mr_raider/Desktop/tickets/hotspot_sass_laravel/resources/views/errors/404.blade.php ENDPATH**/ ?>