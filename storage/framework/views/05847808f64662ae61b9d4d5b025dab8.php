...
<head>
    ...
    <title><?php echo $__env->yieldContent('title', 'Admin'); ?> — <?php echo e(config('platform.name')); ?></title>
    ...
    <div class="vendor-layout">
        ...
        <main class="vendor-main">
            <div class="vendor-topbar">
                ...
                <div class="vendor-topbar-brand"><i class="fas fa-shield-alt"></i> Admin — <?php echo e(config('platform.name')); ?></div>
            </div>
...
$__key ??= \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::generateKey('lw-3985690314-0', $__key);
...
<?php /**PATH /home/mr_raider/Desktop/tickets/hotspot_sass_laravel/resources/views/layouts/admin.blade.php ENDPATH**/ ?>